                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="cart-product-name">اسم الشركة</th>
                                    ...
                                    <tr>
                                        <td class="product-thumbnail">
                                            @if($order->product->image)
                                                <img src="{{ asset('images/products/'.$order->product->id.'/'.$order->product->image) }}" alt="" style="width:100px;height:100px">
                                            @else
                                                <img src="{{ asset('images/products/default.jpg') }}" alt="" style="width:100px;height:100px">
                                            @endif
                                        </td>
                                        <td class="product-name">{{ $order->product->name }}</td>
                                        <td class="product-name">{{ $order->product->company->name }}</td>
                                        <td class="product-price">{{ $order->price }} دينار كويتى </td>
